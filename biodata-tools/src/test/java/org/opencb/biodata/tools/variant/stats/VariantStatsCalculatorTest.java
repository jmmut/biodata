...
public class VariantStatsCalculatorTest extends GenericTest {
    ...
    public void testCalculateBiallelicStats() {
        ...
        VariantStats biallelicStats = VariantStatsCalculator.calculate(result.get(0), sourceEntry.getSamplesData(), sourceEntry.getAttributes(), null);
...
//    private VariantHardyWeinbergStats hw;
    ...
    public void testCalculateMultiallelicStats() {
        ...
        VariantStats multiallelicStats_C = VariantStatsCalculator.calculate(result.get(0), sourceEntry_C.getSamplesData(), sourceEntry_C.getAttributes(), null);;
...
//        assertEquals(6, multiallelicStats_C.getNumSamples());
        ...
        VariantStats multiallelicStats_GC = VariantStatsCalculator.calculate(result.get(1), sourceEntry_GC.getSamplesData(), sourceEntry_GC.getAttributes(), null);;
